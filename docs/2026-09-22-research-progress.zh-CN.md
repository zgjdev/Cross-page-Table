...
5. `docs/reports/2026-09-25-cross-page-table-fragment-reconstruction-methods-and-results.zh-CN.md`；
6. 与当前任务相关的 `docs/experiments/` 最新记录；
7. 服务器 `/data01/public/zhengguojie/paper` 中本文列出的日志、预测和指标。
